...
public class RequestHandler extends Thread {
    ...
    private void seedResponseLines() {
        ...
        this.responseLines.put("unauthorized", "HTTP/1.1 401 Unauthorized");
    ...
    private byte[] getResource(String requestResource) {
        ...
        try {
            fileByteData = Files.readAllBytes(Paths.get("C:\\Users\\345\\Documents\\Java WEB Development\\03. HTTP Protocol\\Javahe HTTP Web Server Asynchr -1.0.0\\src\\resources" + requestResource));
